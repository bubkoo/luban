import { DisposableDelegate, DisposableSet, IDisposable } from '../src/index'
  ...
  describe('DisposableDelegate', () => {
    ...
    describe('#constructor()', () => {
      it('should accept a callback', () => {
        ...
        expect(delegate).toBeInstanceOf(DisposableDelegate)
      })
    })
  ...
  describe('DisposableSet', () => {
    ...
    describe('#constructor()', () => {
      it('should accept no arguments', () => {
        ...
        expect(set).toBeInstanceOf(DisposableSet)
      })
    })
